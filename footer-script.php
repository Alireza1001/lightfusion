<script type="text/javascript">
        ...
        i++){if(ax_confer_placeholder[i].classList[1]==the_input_count){ax_confer_placeholder[i].classList.remove("lf_active");
        }}}else{for(i=0;
        i<ax_confer_placeholder.length;
        i++){if(ax_confer_placeholder[i].classList[1]==the_input_count){ax_confer_placeholder[i].classList.add("lf_active");
        }}}});
        });
        ...
        axsubs_actionPath=wp_dir_url+"/form_ctrl/subscribe_form.php";
        ...
        axconfer_actionPath=wp_dir_url+"/form_ctrl/confer_form.php";
        ...
        */});
        ...
        seacretdeals_reqer.open("GET",wp_dir_url+'/form_ctrl/secretDeals_form.php?PageId='+post_id+'&Email='+document.querySelector("section.lf_secret_deals .lf_content form input").value+'',true);
    ...
    <?php if(is_single() || is_page()) { ?>
        ...
        audio_reqer.open("GET",wp_dir_url+'/form_ctrl/audiostatus_inpage.php?req_page='+post_id+'',true);
        audio_reqer.send();
        ...
        i++){if(lf_item_faq[i].classList[1]=="lf_active"){lf_item_faq[i].classList.remove("lf_active");
        ...
        i++){if(lf_picture_list[i].classList[2]=="lf_active"){item.style.padding=0+"px "+0+"px";
