    ...
    for(i=thei; i>theiafter; i--) {
        if(lf_content_paint_access==1) {
            if(document.scrollingElement.scrollTop > (content_list_top_arr[i-the_current_i_li.length/2]+window.innerHeight/2)) {
                ...
                lf_right_content_list_bg.style.maxHeight = the_current_i_li[i].clientHeight+"px";
                lf_right_content_list_bg.style.transform = "translateY("+(the_current_i_li[i].offsetTop-18)+"px)";
