        ...
        if(item.getAttribute("data") == categoryOrganizer[i].title.toLowerCase().replaceAll(' ', '_')) {
            ...
            if(categoryOrganizer[i].content.length == 0) {
                ...
                for(k=0; k<categoryOrganizer[i].content.length; k++){
                    if(!categoryOrganizer[i].content[k].hide) {
                        lf_available_course = "";
                        ...
                        for(j=2; j<categoryOrganizer[i].content[k].length; j++) ax_services_sub_data += '<li><a href="'+categoryOrganizer[i].content[k].content[j].link+'">'+categoryOrganizer[i].content[k].content[++j].title+'</a></li>';
