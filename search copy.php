<div id="axg_header_search">
    <form id="axg_header_search_form" method="POST">
        <label for="axg_isearch_button">search</label>
        <button type="submit" name="ax_submit" title="ax_submit" id="axg_isearch_button">
