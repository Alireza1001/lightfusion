            ...
            <ul class="lf_share_btns">
                <div>
                    <li class="lf_share_event lf_media_facebook">
                        <a aria-label="facebook" target="_blank" rel="noopener noreferrer" href="https://facebook.com/sharer.php?u=<?php echo get_the_permalink(); ?>&t=<?php echo get_the_title(); ?>">
                            <img alt="facebook" width="20px" height="20px" src="<?php echo get_template_directory_uri(); ?>/assets/icons/facebook.svg" />
                        </a>
                    </li>
                    <li class="lf_share_event lf_media_pinterest">
                        <a aria-label="pinterest" target="_blank" rel="noopener noreferrer" href="https://pinterest.com/pin/create/button/?description=<?php echo get_the_title(); ?>&media=<?php echo get_the_post_thumbnail_url(); ?>&url=<?php echo get_the_permalink(); ?>">
                            <img alt="pinterest" width="20px" height="20px" src="<?php echo get_template_directory_uri(); ?>/assets/icons/pinterest.svg" />
                        </a>
                    </li>
                    <li class="lf_share_event lf_media_email">
                        <a aria-label="email" target="_blank" href="mailto:?subject=<?php echo get_the_title(); ?>&body=Check out this site <?php echo get_the_permalink(); ?>">
                            <img alt="email" width="20px" height="20px" src="<?php echo get_template_directory_uri(); ?>/assets/icons/gmail.svg" />
                        </a>
                    </li>
                    <li class="lf_share_event lf_media_twitter">
                        <a aria-label="twitter" target="_blank" rel="noopener noreferrer" href="https://twitter.com/intent/tweet?url=<?php echo get_the_permalink(); ?>&text=<?php echo get_the_title(); ?>&hashtags=homapilot">
                            <img alt="twitter" width="20px" height="20px" src="<?php echo get_template_directory_uri(); ?>/assets/icons/twitter.svg" />
                        </a>
                    </li>
                    <li class="lf_share_event lf_media_whatsapp">
                        <a aria-label="whatsapp" target="_blank" rel="noopener noreferrer" href="https://wa.me/?text=<?php echo get_the_permalink(); ?>">
                            <img alt="whatsapp" width="20px" height="20px" src="<?php echo get_template_directory_uri(); ?>/assets/icons/whatsapp.svg" />
                        </a>
                    </li>
                    <li class="lf_share_event lf_media_telegram">
                        <a aria-label="telegram" target="_blank" rel="noopener noreferrer" href="https://telegram.me/share/url?url=<?php echo get_the_permalink(); ?>&text=<?php echo get_the_title(); ?>">
                            <img alt="telegram" width="20px" height="20px" src="<?php echo get_template_directory_uri(); ?>/assets/icons/telegram.svg" />
                        </a>
                    </li>
                    <li class="lf_share_event lf_media_linkedin">
                        <a aria-label="linkedin" target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo get_the_permalink(); ?>&title=<?php echo get_the_title(); ?>&summary=<?php echo get_the_excerpt(); ?>&source=homapilot">
                            <img alt="linkedin" width="20px" height="20px" src="<?php echo get_template_directory_uri(); ?>/assets/icons/linkedin.svg" />
                        </a>
                    </li>
                    <li class="lf_share_event lf_media_blogger">
                        <a aria-label="blogger" target="_blank" rel="noopener noreferrer" href="https://www.blogger.com/blog-this.g?n=<?php echo get_the_excerpt(); ?>&t=<?php echo get_the_title(); ?>&u=<?php echo get_the_permalink(); ?>">
                            <img alt="blogger" width="20px" height="20px" src="<?php echo get_template_directory_uri(); ?>/assets/icons/blogger.svg" />
                        </a>
                    </li>
                    <li class="lf_share_event lf_media_tumblr">
                        <a aria-label="tumblr" target="_blank" rel="noopener noreferrer" href="https://www.tumblr.com/share?t=<?php echo get_the_title(); ?>&u=<?php echo get_the_permalink(); ?>">
                            <img alt="tumblr" width="20px" height="20px" src="<?php echo get_template_directory_uri(); ?>/assets/icons/tumblr.svg" />
                        </a>
                    </li>
                    <li class="lf_share_event lf_media_reddit">
                        <a aria-label="reddit" target="_blank" rel="noopener noreferrer" href="http://www.reddit.com/submit?url=<?php echo get_the_permalink(); ?>&title=<?php echo get_the_title(); ?>">
                            <img alt="reddit" width="20px" height="20px" src="<?php echo get_template_directory_uri(); ?>/assets/icons/reddit.svg" />
                        </a>
                    </li>
                    <li class="lf_share_event lf_media_sms">
                        <a aria-label="sms" target="_blank" href="sms:?body=Hi there. Check out<?php echo get_the_permalink(); ?>">
                            <img alt="sms" width="20px" height="20px" src="<?php echo get_template_directory_uri(); ?>/assets/icons/sms.svg" />
                        </a>
                    </li>
                    <li class="lf_share_event lf_media_rss">
                        <a aria-label="rss" target="_blank" href="https://homapilot.com/feed/">
                            <img alt="rss" width="20px" height="20px" src="<?php echo get_template_directory_uri(); ?>/assets/icons/rss.svg" />
                        </a>
                    </li>
                    <li class="lf_share_event lf_media_print" id="lf_landing_print">
                        <a aria-label="print" target="_blank" href="#">
                            <img alt="print" width="20px" height="20px" src="<?php echo get_template_directory_uri(); ?>/assets/icons/printer.svg" />
                        </a>
                    </li>
                    <li class="lf_share_event lf_media_url lf_d">
                        <p aria-label="url">
                            <img alt="url" width="20px" height="20px" src="<?php echo get_template_directory_uri(); ?>/assets/icons/copy.svg" />
                        </p>
                    </li>
                </div>
